-- Sessions
INSERT INTO sessions (id, title, target_language) VALUES
    ('a1000000-0000-0000-0000-000000000001', 'Dutch Beginners Coffee Chat', 'Dutch'),
    ('a1000000-0000-0000-0000-000000000002', 'English Conversation Practice', 'English'),
    ('a1000000-0000-0000-0000-000000000003', 'Japanese Evening Study Group', 'Japanese');

-- Participants
INSERT INTO participants (id, session_id, display_name, native_language, proficiency_level, is_host) VALUES
    -- Dutch session
    ('b1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'Maria', 'English', 'A2', true),
    ('b1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'Yuki', 'Japanese', 'A1', false),
    ('b1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000001', 'Tom', 'English', 'A2', false),
    -- English session
    ('b1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000002', 'Sanne', 'Dutch', 'B1', true),
    ('b1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000002', 'Haruto', 'Japanese', 'B1', false),
    -- Japanese session
    ('b1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000003', 'Lisa', 'English', 'A1', true),
    ('b1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000003', 'Bram', 'Dutch', 'A2', false);
...
-- Session cards used
INSERT INTO session_cards_used (session_id, card_id, participant_id) VALUES
    ('a1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001'),
    ('a1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000002'),
    ('a1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000004'),
    ('a1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000008', 'b1000000-0000-0000-0000-000000000006');